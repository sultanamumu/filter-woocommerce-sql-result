...
<?php
$payment_method = array('Cash on delivery'); // ('Cash on delivery', 'Credit or Debit card (Stripe)', '	Dokan Credit card (Stripe)')

$orders = wc_get_orders( array(
				'status'=> array( $status ), //('wc-completed', 'wc-processing','on-hold')
